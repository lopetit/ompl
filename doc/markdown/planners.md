...
- **Single-query planners**<br>
  ...
  - [Rapidly-exploring Random Trees (RRT)](\ref gRRT)<br>
    ...
    - [RRT Rope (RRTRope)](\ref gRRTRope)<br>
      This planner uses an altered version of RRT-connect, and a deterministic shortening technique once a feasible path is found. It usually outperforms other algorithms in large uncluttered environments in R3 state space.
    - [RRT*](\ref gRRTstar)<br>
